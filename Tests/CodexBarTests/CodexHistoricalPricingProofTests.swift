...
struct CodexHistoricalPricingProofTests {
    ...
    func `writes redacted real scan proof for GPT56 historical pricing`() async throws {
        ...
        #expect(abs((terraBefore.costUSD ?? 0) - ((90.0 * 2.5e-6) + (10.0 * 2.5e-7) + (5.0 * 1.5e-5))) < 1e-7)
        #expect(abs((terraAfter.costUSD ?? 0) - ((90.0 * 2e-6) + (10.0 * 2e-7) + (5.0 * 1.2e-5))) < 1e-7)
        #expect(abs((lunaBefore.costUSD ?? 0) - ((90.0 * 1e-6) + (10.0 * 1e-7) + (5.0 * 6e-6))) < 1e-7)
        #expect(abs((lunaAfter.costUSD ?? 0) - ((90.0 * 2e-7) + (10.0 * 2e-8) + (5.0 * 1.2e-6))) < 1e-7)
